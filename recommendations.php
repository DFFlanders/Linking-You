...
<p>An abstract space that is perfectly organised relies on the agreement and co-ordination of a number of technologies (e.g. networking, web servers, browsers). In our physical spaces, technologies work together so as to assure the appearance and experience of order and continuity. The same goes for the design and development of our cyber spaces, where an appreciation of how each technology can conceal the complexity of the other. For example, web servers can hide file extensions and seamlessly map one directory onto another, URIs can be constructed according to a grammar that is meaningful over time, browsers can integrate the location bar with search features and so on. The abstract space of the URI must be thought about and designed so that it is not only perfectly organised but persistent (trustworthy, reliable) and offers us a constructive grammar of signs which can be understood by human and machine.</p> 
...
<div>
<blockquote>A resource can be anything that has identity."
<a href="http://tools.ietf.org/html/rfc2396">RFC 2396, Uniform Resource Identifiers (URI): Generic Syntax</a></blockquote>
</div>
<div><blockquote>Think of the URI space as an abstract space, perfectly organized." <a href="http://www.w3.org/Provider/Style/URI">Cool URIs don't change</a></blockquote></div>
</div>
</div>
=======
...
>>>>>>> 150d4b756b6f0bc3c676c0357769bae13c09efbf
