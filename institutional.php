<article class="grid_12"> 
	...
	<h1>Institutional URIs</h1>
		...
		<p>However, for some of the more “static” pages such as research and business services, most institutions seems to have followed best practise (and again, what we are recommending in our model) by using <span class="uri">/business</span> and <span class="uri">/research</span> as the namespaces. Those institutions using alternative URIs for these pages there appears to be a mixture of content management systems influencing the URIs (e.g. Reading: <span class="uri">/working-with-business</span>) and alternative terms such as <span class="uri">/enterprise</span> and <span class="uri">/partnerships</span>.</p>
		
		<p>One interesting trend can be found in the about pages. Most institutions go with the URI /about, however a lot of universities have their abbreviated name in the URI, e.g. Nottingham Trent: <span class="uri">/about_ntu</span>, and De Montford: <span class="uri">/about_dmu</span>. Again, this could be down to the content management system rendering URIs based on page titles, but in any case this is case of having unnecessary information in the URI which goes against best practises.</p>
		
		<p>Also a number of institutions place their contact page inside the <span class="uri">/about</span> namespace which seems illogical because contacting the university is a call to action and therefore deserves it’s own top level URI at <span class="uri">/contact</span>.</p>
